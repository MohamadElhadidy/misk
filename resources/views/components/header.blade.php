        ...
        <div class="header-menu style-one relative bg-white w-full md:h-[74px] h-[56px]">
            <div class="container mx-auto h-full">
                <div class="header-main flex items-center justify-between h-full">
                    ...
                    <a href="/" class="flex items-center lg:hidden absolute left-1/2 -translate-x-1/2">
                        <div class="heading4">Misk</div>
                    </a>
                    <div class="form-search relative max-lg:hidden z-[1]">
                        ...
                        <input type="text" placeholder="What are you looking for?"
                            class="h-10 rounded-lg border border-line caption2 w-full pl-9 pr-4" />
                    </div>
                    <div class="menu-main h-full w-screen xl:absolute xl:left-1/2 xl:-translate-x-1/2 max-lg:hidden">
                        <ul class="flex items-center justify-center gap-8 h-full">
                                                    ...
                                                    <div class="product-item grid-type" data-item="49">
                                                        <div class="product-main cursor-pointer block">
                                                            <div
                                                                ...
                                                                <div
                                                                    class="product-tag text-button-uppercase bg-red text-white px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">
                                                                    Sale</div>
                                                                <div
                            ...
                            <li class="h-full flex items-center justify-center logo">
                                <a href="/" class="heading4"> Misk </a>
                            </li>
                            <li class="h-full">
                                <a href="#!"
                                    class="text-button-uppercase duration-300 h-full flex items-center justify-center">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="product-default.html"
                                                            class="link text-secondary duration-300"> Products Defaults
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="product-grouped.html"
                                                            class="link text-secondary duration-300"> Products Grouped
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-bought-together.html"
                                                            class="link text-secondary duration-300"> Frequently Bought
                                                            Together </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-out-of-stock.html"
                                                            class="link text-secondary duration-300"> Products Out Of
                                                            Stock </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-variable.html"
                                                            class="link text-secondary duration-300"> Products Variable
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="product-external.html"
                                                            class="link text-secondary duration-300"> Products External
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-on-sale.html"
                                                            class="link text-secondary duration-300"> Products On Sale
                                                        </a>
                                                    </li>
                                                    <li>
                            ...
                            <li class="h-full relative">
                                ...
                                <div class="sub-menu py-3 px-5 -left-10 absolute bg-white rounded-b-xl">
                                    <ul class="w-full">
                                        <li>
                                            <a href="blog-default.html" class="link text-secondary duration-300"> Blog
                                                Default </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="blog-detail1.html" class="link text-secondary duration-300"> Blog
                                                Detail 1 </a>
                                        </li>
                                        <li>
                                            <a href="blog-detail2.html" class="link text-secondary duration-300"> Blog
                                                Detail 2 </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="h-full relative">
                                ...
                                <div class="sub-menu py-3 px-5 -left-10 absolute bg-white rounded-b-xl">
                                    <ul class="w-full">
                                        ...
                                        <li>
                                            <a href="store-list.html" class="link text-secondary duration-300"> Store
                                                List </a>
                                        </li>
                                        <li>
                ...
                <div class="container h-full">
                    <div class="menu-main h-full overflow-hidden">
                        <div class="heading py-2 relative flex items-center justify-center">
                            ...
                            <a href="/" class="logo text-3xl font-semibold text-center">Misk</a>
                        </div>
                        ...
                        <div class="list-nav mt-6">
                            <ul>
                                <li>
                                    <a href="/"
                                        class="text-xl font-semibold flex items-center justify-between">Shop
                                    </a>
                                            ...
                                            <ul class="w-full">
                                                ...
                                                <li>
                                                    <a href="store-list.html"
                                                        class="link text-secondary duration-300"> Store List </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="coming-soon.html"
                                                        class="link text-secondary duration-300"> Coming Soon </a>
                                                </li>
                                                <li>
                                                    <a href="customer-feedbacks.html"
