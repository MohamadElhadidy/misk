<x-adminLayout>
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-6 w-full max-w-6xl">
        ...
        <div class="flex items-center p-4 bg-white rounded">
            <div class="flex flex-shrink-0 items-center justify-center bg-white-200 h-16 w-16 rounded">
            ...
            <div class="flex-grow flex flex-col ml-4">
                <span class="text-xl font-bold">{{$total_orders}}</span>
        ...
        <div class="flex items-center p-4 bg-white rounded">
            ...
            <div class="flex-grow flex flex-col ml-4">
                <span class="text-xl font-bold">{{$delivered_orders}}</span>
                <div class="flex items-center justify-between">
...
{{--                    <span class="text-green-500 text-sm font-semibold ml-2">+12.6%</span>--}}
        ...
        <div class="flex items-center p-4 bg-white rounded">
            ...
            <div class="flex-grow flex flex-col ml-4">
                <span class="text-xl font-bold">{{$total_revenue}} {{config('app.currency')}}</span>
                <div class="flex items-center justify-between">
    ...
    <div class="flex justify-center mt-10">
            ...
            <div class="w-11/12 mx-auto">
                <div class="bg-white my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
                        <tr>
                            <th class="py-4 px-6 bg-black font-bold uppercase text-sm text-white border-b border-grey-light">Metric</th>
                            <th class="py-4 px-6 text-center bg-black font-bold uppercase text-sm text-white border-b border-grey-light">Count</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">Total Customers</td>
                            <td class="py-4 px-6 text-center border-b border-grey-light">{{ $customer_count }}</td>
                        </tr>
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">Total Orders</td>
                            <td class="py-4 px-6 text-center border-b border-grey-light">{{ $total_orders }}</td>
                        </tr>
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">Delivered Orders</td>
                            <td class="py-4 px-6 text-center border-b border-grey-light">{{ $delivered_orders }}</td>
                        </tr>
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">Total Revenue</td>
                            <td class="py-4 px-6 text-center border-b border-grey-light">{{ $total_revenue }} {{ config('app.currency') }}</td>
                        </tr>
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">Total Products</td>
                            <td class="py-4 px-6 text-center border-b border-grey-light">{{ $total_products }}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <!-- Table 2 - Top Products (replace Keywords table) -->
            ...
            <div class="w-11/12 mx-auto">
                <div class="bg-white my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
                        <tr>
                            <th class="py-4 px-6 bg-black font-bold uppercase text-sm text-white border-b border-grey-light">PRODUCT</th>
                            <th class="py-4 px-6 text-center bg-black font-bold uppercase text-sm text-white border-b border-grey-light">TOTAL SALES</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach($top_products as $product)
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light"><a href="/products/{{ $product->id }}" class="hover:underline" target="_blank">{{ $product->name }}</a></td>
                                <td class="py-4 px-6 text-center border-b border-grey-light">{{ $product->total_sales }}</td>
                            </tr>
                        @endforeach
                        @else
        ...
        <!-- Table 3 - Top 5 Customers (replace MSISDN and Points table) -->
            ...
            <div class="w-11/12 mx-auto">
                <div class="bg-white my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
                        <tr>
                            <th class="py-4 px-6 bg-black font-bold uppercase text-sm text-white border-b border-grey-light">CUSTOMER</th>
                            <th class="py-4 px-6 text-center bg-black font-bold uppercase text-sm text-white border-b border-grey-light">TOTAL SPENT</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach($top_customers as $customer)
                            <tr class="hover:bg-grey-lighter">
                                ...
                                <td class="py-4 px-6 text-center border-b border-grey-light">{{ $customer->total_spent }} {{ config('app.currency') }}</td>
                            </tr>
                        @endforeach
                        @else
                            <tr class="text-center">
